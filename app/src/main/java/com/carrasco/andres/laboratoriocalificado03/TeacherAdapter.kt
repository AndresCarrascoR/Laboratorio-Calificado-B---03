...
import com.carrasco.andres.laboratoriocalificado03.databinding.ItemTeacherBinding
        ...
        fun bind(teacher: TeacherResponse) {
            ...
            binding.root.setOnClickListener {
                ...
                try {
                    ...
                    Toast.makeText(context, "Acceso restringido para realizar llamadas", Toast.LENGTH_SHORT).show()
                } catch (e: Exception) {
            ...
            binding.root.setOnLongClickListener {
                ...
                try {
                    ...
                    Toast.makeText(context, "Error al tratar de enviar el correo", Toast.LENGTH_SHORT).show()
                }
                true
            }
        }
